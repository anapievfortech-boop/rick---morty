...
const CharDetails: FC<CardProps> = ({ name, species, gender, status, origin, type, location }) => {
    return (
        <>
            <div className='top-details wrapper'>
                <Link className='link-back' to="/">
                <button className='go-back-button'>
                    <img src={arroBack} alt="button-back" style={{ marginRight: 8, height: 24 }} />
            ...
            <div className='bottom-details wrapper'>
                <div className='information'>
                    ...
                    <ul className='details-list'>
                        ...
                        <li className='list-item'><p className='list-chapter'>Status</p>
                            <p className='list-descr'>{status}</p></li>
                        <li className='list-item'>
